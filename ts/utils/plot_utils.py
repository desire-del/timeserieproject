...
def decomposition_plot(
        ts_index, observed=None, seasonal=None, trend=None, resid=None, title = "Seasonal Decomposition", width=1200, height=720
    ):
...
def decorate_plot(fig, legends = None, xlabel="Time", ylabel="Value", figsize=(400,700), font_size=15, title_font_size=20):
    if legends:
        names = cycle(legends)
